package com.dynamicelement.sdk.android.ui.util;
...
/**
 * A {@link androidx.appcompat.widget.AppCompatTextView} that can be adjusted to a specified aspect ratio.
 */
public class AutoFitTextView extends androidx.appcompat.widget.AppCompatTextView {
    private static final String TAG = "AUTO_FIT_TEXT_VIEW";
    private int ratioWidth = 0;
    private int ratioHeight = 0;
    private CameraParameters.CameraRatioMode ratioMode;
    ...
    public void setAspectRatio(CameraParameters.CameraRatioMode ratioMode) {
        this.ratioWidth = ratioMode == RATIO_1X1 ? 1 : 3;
        this.ratioHeight = ratioMode == RATIO_1X1 ? 1 : 4;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        double widthPercentageFactor = (2.3 / (this.ratioMode == RATIO_1X1 ? 4 : 3));
        double heightPercentageFactor = (0.5 / 4);

        int modifiedWidth = (int) (getMeasuredWidth() * widthPercentageFactor);
        int modifiedHeight = (int) (getMeasuredHeight() * heightPercentageFactor);

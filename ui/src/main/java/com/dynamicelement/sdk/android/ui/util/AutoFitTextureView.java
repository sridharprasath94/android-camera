...
public class AutoFitTextureView extends TextureView {
    private static final String TAG = "AUTO_FIT_TEXTURE_VIEW";
    ...
    public void setAspectRatio(CameraParameters.CameraRatioMode ratioMode) {
        ratioWidth = ratioMode == CameraParameters.CameraRatioMode.RATIO_1X1 ? 1 : 3;
        ratioHeight = ratioMode == CameraParameters.CameraRatioMode.RATIO_1X1 ? 1 : 4;
        requestLayout();
    }

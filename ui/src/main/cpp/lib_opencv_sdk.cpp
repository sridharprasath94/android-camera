...
Java_com_flashandroid_sdk_misc_ImageProcessing_cvtGrayscaledBitmap(JNIEnv *env, jclass p_this,
...
extern "C" JNIEXPORT void JNICALL
Java_com_flashandroid_sdk_misc_ImageProcessing_cvtResizedBitmap(JNIEnv *env, jclass p_this,
                                                   jobject bitmapIn, jobject bitmapOut) {
    Mat src;
    Mat out;
    Mat dst;
...
extern "C" JNIEXPORT void JNICALL
Java_com_flashandroid_sdk_misc_ImageProcessing_cvtResizedGrayscaledBitmap(JNIEnv *env, jclass p_this,
                                                             jobject bitmapIn,
                                                             jobject bitmapOut) {
    Mat src;
    Mat out;
...
extern "C" JNIEXPORT void JNICALL
Java_com_flashandroid_sdk_misc_ImageProcessing_cvtResizedGrayscaledBitmapFromFile(JNIEnv *env,
                                                                     jclass p_this,
                                                                     jstring filePath,
                                                                     jobject bitmapOut) {
    Mat src;
...
extern "C" JNIEXPORT void JNICALL
Java_com_flashandroid_sdk_misc_ImageProcessing_cvtBarcodeBitmap1(JNIEnv *env, jclass p_this,
                                                    jobject bitmapIn, jobject bitmapOut,
                                                    jfloat sigma) {
    Mat src;
    Mat out;
...
extern "C" JNIEXPORT void JNICALL
Java_com_flashandroid_sdk_misc_ImageProcessing_cvtBarcodeBitmap2(JNIEnv *env, jclass p_this,
                                                    jobject bitmapIn, jobject bitmapOut,
                                                    jfloat sigma) {
    Mat src;
    Mat out;
...
Java_com_flashandroid_sdk_misc_ImageProcessing_getImageVariance(JNIEnv *env, jclass p_this,
                                                jobject bitmapIn, jobject bitmapOut) {
    Mat src;
    Mat out;
    Mat dst;
